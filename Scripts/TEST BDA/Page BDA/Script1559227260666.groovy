...
WebUI.delay(3)
WebUI.verifyTextPresent('PORTFOLIO', false)

//Test Menu CLIENT
WebUI.click(findTestObject('Object Repository/Test BDA/CLIENT BT'))
WebUI.delay(3)
WebUI.verifyTextPresent('OUR CLIENTS', false)
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/Test BDA/CAREERS BT'))
WebUI.delay(3)
WebUI.verifyTextPresent("LET'S WORK TOGETHER", false)
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/Test BDA/Contact bt'))
WebUI.delay(3)
WebUI.verifyTextPresent('BANGKOK', false)
WebUI.verifyTextPresent('CHIANG MAI', false)
WebUI.delay(3)
